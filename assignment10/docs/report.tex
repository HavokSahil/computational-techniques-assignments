...
\title{\textbf{Assignment 10}\\Jacobi Diagonalization and Principal Axes}
...
\chapter{Moment of Inertia Matrix and Principal Axes of a Dumbbell}
\input{report1.tex}

\chapter{Principal Moments and Principal Axes of a Uniform Cube}
\input{report2.tex}

\chapter{Jacobi Diagonalization of a 3--Level Quantum Hamiltonian}
\input{report3.tex}
